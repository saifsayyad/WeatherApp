...
try:
    release = pkg_resources.get_distribution('weatherapp').version
except pkg_resources.DistributionNotFound:
    print('WeatherApp must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "saifsayyad/weatherapp",
    "github_ribbon_color": "white_ffffff",
    "github_user": "saifsayyad",
}
...
htmlhelp_basename = 'WeatherAppdocs'
...
latex_documents = [
    (master_doc, 'WeatherApp.tex', 'WeatherApp Documentation',
...
man_pages = [
    (master_doc, 'WeatherApp', 'WeatherApp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WeatherApp', 'WeatherApp Documentation',
     author, 'WeatherApp', 'One line description of project.',
     'Miscellaneous'),
]
